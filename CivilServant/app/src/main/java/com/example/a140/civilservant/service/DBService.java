package com.example.a140.civilservant.service;
...
public class DBService {
    ...
    public DBService() {
        //连接数据库
        db = SQLiteDatabase.openDatabase("/data/data/com.example.a140.civilservant/databases/question.db", null, SQLiteDatabase.OPEN_READWRITE);
    }
